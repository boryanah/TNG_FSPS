...
SubhaloGrNr_fp = np.load(root+'SubhaloGrNr_fp_55.npy').astype(int)
SubhaloGrNr_dm = np.load(root+'SubhaloGrNr_dm_55.npy').astype(int)
SubhaloParent_fp = np.load(root+'SubhaloParent_fp_55.npy').astype(int)
SubhaloParent_dm = np.load(root+'SubhaloParent_dm_55.npy').astype(int)
GroupFirst_fp = np.load(root+'GroupFirstSub_fp_55.npy').astype(int)
GroupFirst_dm = np.load(root+'GroupFirstSub_dm_55.npy').astype(int)
GroupPos_fp = np.load(root+'GroupPos_fp_55.npy')
GroupPos_dm = np.load(root+'GroupPos_dm_55.npy')
fp_dmo_inds_sub = np.load(root+'fp_dmo_inds_sub_55.npy').astype(int)
...
np.save(root+"fp_dmo_halo_inds_55.npy",fp_dmo_halo_inds)
plt.plot(np.arange(205000),np.arange(205000),'k--')
...
plt.show()
quit()
# what are the firsts of these DM parents
first_dm = GroupFirst_dm[par_dm]
# which of these firsts have matches in FP
first_dm,comm1,comm2 = np.intersect1d(dmo_inds_sub,first_dm,return_indices=True)
# what are the subhalos in FP that are matched
sub_fp = fp_inds_sub[comm1]
# what are the parents in DM that have matches in FP
par_dm = par_dm[comm2]
# what are the parents of these FP subhalos
par_fp = SubhaloGrNr_fp[sub_fp]
